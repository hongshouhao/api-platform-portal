  ...
  <div>
    ...
    <Tabs value="ReRoutes" class="cardView">
      <TabPane label="ReRoutes" name="ReRoutes">
        <ReRoutesView class="content" :vmodel="vconfigtempl.ReRoute"></ReRoutesView>
      </TabPane>
      <TabPane label="DynamicReRoutes" name="DynamicReRoutes">
        <DynamicReRoutesView class="content" :vmodel="vconfigtempl.DynamicReRoute"></DynamicReRoutesView>
      </TabPane>
      <TabPane label="Aggregates" name="Aggregates">
        <AggregatesView class="content" :vmodel="vconfigtempl.Aggregate"></AggregatesView>
      </TabPane>
      <TabPane label="Global" name="GlobalConfiguration">
        <GlobalView class="content" :vmodel="vconfigtempl.GlobalConfiguration"></GlobalView>
      </TabPane>
    </Tabs>
  </div>
</template>
