  ...
  <div>
    <Form :model="vmodel" :label-width="155" class="vue-form-label-icon">
      <FormItem label="Key">
        <Row>
          <Col span="1">
            <Tooltip placement="right" content="属性名(用于服务聚合时)" theme="light" :delay="500">
      ...
      <FormItem label="ServiceName">
        <Row>
          <Col span="1">
            <Tooltip placement="right" content="服务名(用于服务发现)" theme="light" :delay="500">
              <Icon type="ios-information-circle"/>
            </Tooltip>
          </Col>
          <Col span="23">
      ...
      <FormItem label="DownstreamPathTemplate" class="highlight">
        <Row>
          <Col span="1">
            <Tooltip placement="right" content="原始地址" theme="light" :delay="500">
              <Icon type="ios-information-circle"/>
            </Tooltip>
          </Col>
          <Col span="23">
      ...
      <FormItem label="DownstreamScheme" class="highlight">
        <Row>
          <Col span="1">
            <Tooltip placement="right" content="http或https" theme="light" :delay="500">
              <Icon type="ios-information-circle"/>
            </Tooltip>
          </Col>
          <Col span="23">
      ...
      <FormItem label="Timeout">
        <Row>
          <Col span="1">
            <Tooltip placement="right" content="超时" theme="light" :delay="500">
              <Icon type="ios-information-circle"/>
            </Tooltip>
          </Col>
          <Col span="23">
      ...
      <FormItem label="Priority">
        <Row>
          <Col span="1">
            <Tooltip placement="right" content="优先级" theme="light" :delay="500">
              <Icon type="ios-information-circle"/>
            </Tooltip>
          </Col>
          <Col span="23">
      ...
      <Row>
        ...
        <Col span="12">
          <FormItem label="DangerousAcceptAnyServerCertificateValidator" :label-width="300">
      ...
      <Card class="mar10 highlight" dis-hover>
        ...
        <FormItem label="AuthenticationProviderKey" class="highlight">
          <Row>
            <Col span="1">
              <Tooltip placement="right" content="授权方案" theme="light" :delay="500">
                <Icon type="ios-information-circle"/>
              </Tooltip>
            </Col>
            <Col span="23">
              <Select
                ...
                @on-open-change="loadAuthOptions"
                @on-change="authOptionSelected"
        ...
        <FormItem label="AllowedScopes" class="highlight">
          <Row>
            <Col span="1">
              <Tooltip placement="right" content="权限范围" theme="light" :delay="500">
                <Icon type="ios-information-circle"/>
              </Tooltip>
            </Col>
            <Col span="23">
              <ScopeEditor :idsHost="url" :scopes="vmodel.AuthenticationOptions.AllowedScopes"></ScopeEditor>
            </Col>
          </Row>
        </FormItem>
      </Card>
