        ...
        <Row>
          <Col span="12">
            <FormItem label="NameOrSchema">
              <Input
                v-model="voptions.TokenRetrievalOptions.NameOrSchema"
              ></Input>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="Source">
              <Select v-model="voptions.TokenRetrievalOptions.Source">
                <Option value="FromAuthorizationHeader"
                  >FromAuthorizationHeader</Option
                >
...
export default {
  ...
  methods: {
    displayWellKnown() {
      var _this = this
      _this.$axios
        .get(_this.voptions.Authority + config.ids.wellKnownUri)
