...
if (process.env.BASE_URL) {
  config.oidc.redirect_uri = host + "/" + process.env.BASE_URL + config.oidc.redirect_uri
  config.oidc.silent_redirect_uri = host + "/" + process.env.BASE_URL + config.oidc.silent_redirect_uri
}
else {
